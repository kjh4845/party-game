...
class CharacterImportParityVerifier
  ...
  def validate_scope
    ...
    allowed_prefixes = ["BlenderSource/Characters/C1B-005/","BlenderSource/Characters/C1B-RW-002/","Project hotfix/Assets/ProjectHotfix/Art","Project hotfix/Assets/ProjectHotfix/Editor/C1B005","Project hotfix/Assets/ProjectHotfix/Tests/EditMode/C1B005","artifacts/evidence/G0/C1B-005/","artifacts/evidence/G0/C1BRW-002/"]
    allowed = FILE_HASHES.keys + ["Project hotfix/Assets/ProjectHotfix/Editor.meta","tools/verify_character_import_parity.rb","tools/tests/verify_character_import_parity_test.rb","tools/verify_character_pose_lineup.rb","tools/verify_art_profiles.rb","tools/tests/verify_art_profiles_test.rb","tools/blender/create_c1b_rw002_neutral.py","tools/blender/inspect_c1b_rw002_neutral.py","tools/verify_c1b_rw002_neutral.rb","tools/tests/verify_c1b_rw002_neutral_test.rb","docs/00_DOCUMENT_INDEX.md","docs/ART_DIRECTION.md","docs/CHARACTER_TECHNICAL_SPEC.md","docs/WEAPON_DESIGN.md","docs/03_IMPLEMENTATION_PLAN.md","docs/04_IMPLEMENTATION_TRACEABILITY.md","artifacts/evidence/docs/verify_doc_baseline.py","artifacts/reports/FOUNDATION_DECISION_RATIONALE.md","artifacts/reports/CHARACTER_FULL_AUDIT.md","artifacts/reports/CHARACTER_REWORK_NEUTRAL_REVIEW.md","config/character/CharacterProportionProfile-C1B-RW-001-r01.yaml","config/repository/BinaryAssetPolicy.md","config/repository/BinaryAssetInventory.yaml","config/licenses/LicensePolicy.yaml","config/licenses/ThirdPartyInventory.yaml","tools/verify_lfs_repository.rb","tools/tests/verify_lfs_repository_test.rb","tools/verify_license_inventory.rb","tools/tests/verify_license_inventory_test.rb"]
