...
class LfsRepositoryVerifier
  ...
  def validate_policy
    ...
    required_markers = [
      ...
      "`548a786a…e252`, `520225` bytes",
      "its `131`-byte index pointer and authenticated fresh-clone fetch/checkout reproduced the materialized SHA-256 and byte size exactly",
