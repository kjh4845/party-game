...
class LfsRepositoryVerifier
  ...
  def validate_policy
    ...
    required_markers = [
      ...
      "`e2049505f6be24508783710c83691445b28fa39cad892bcd88aa0e2ad4807d9d`, `70268` bytes",
      "A fresh private clone first confirmed its `130`-byte pointer and declared OID/size",
