...
class C1BRW002NeutralVerifier
  ...
  def validate_manifest
    ...
    expect(blend["status"] == "COMPLETE" && blend["path"] == SOURCE && blend["bytes"] == 157613 && blend["sha256"] == SOURCE_SHA && blend["lfsState"] == "VERIFIED_REMOTE_ROUND_TRIP" && blend["indexPointerVerified"] == true && blend["remoteObjectRoundTripVerified"] == true, "MANIFEST_BLEND_STAGE", MANIFEST)
