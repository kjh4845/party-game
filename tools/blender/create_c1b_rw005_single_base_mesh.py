...
"""Validate, render, and copy the frozen C1B r05 review surface."""
...
ASSET_VERSION = "0.5.0-local-preview"
ASSET_REVISION = "r05"
...
CONSTRUCTION = "FROZEN_APPLIED_SINGLE_SURFACE_10528_QUADS"
...
CANONICAL_BLEND = os.path.join(
    ...
    "Characters",
    "C1B-RW-005-preview",
    "CHR_MasterCharacter_C1B_NeutralRework_r05.blend",
)
...
def main():
    ...
    body = bpy.data.objects["C1B_R05_SingleQuadBody"]
    head = bpy.data.objects["C1B_R05_RoundFacelessHead"]
    if body.modifiers:
    ...
    print(f"C1B_RW005_BLEND={blend_path}")
    print(f"C1B_RW005_RENDER_DIRECTORY={render_directory}")
    print(f"C1B_RW005_REPORT={report_path}")
    print(f"C1B_RW005_RENDER_COUNT={len(outputs)}")
    print("C1B_RW005_BASE_EXACT_QA=" + json.dumps(base, sort_keys=True, separators=(",", ":")))
    print("C1B_RW005_EVALUATED_EXACT_QA=" + json.dumps(evaluated, sort_keys=True, separators=(",", ":")))
    print("C1B_RW005_GENERATION_RESULT=PASS")
