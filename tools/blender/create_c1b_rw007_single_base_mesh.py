...
"""Validate, render, and copy the frozen C1B r07 review surface."""
...
ASSET_VERSION = "0.7.0-local-preview"
ASSET_REVISION = "r07"
...
CONSTRUCTION = "LARGE_TORSO_SHORT_ROOT_SEPARATED_ARM_BISECT_MIRRORED_143560_QUADS"
...
CANONICAL_BLEND = os.path.join(
    ...
    "Characters",
    "C1B-RW-007-preview",
    "CHR_MasterCharacter_C1B_NeutralRework_r07.blend",
)
...
def main():
    ...
    body = bpy.data.objects["C1B_R07_SingleQuadBody"]
    head = bpy.data.objects["C1B_R07_RoundFacelessHead"]
    if body.modifiers:
    ...
    print(f"C1B_RW007_BLEND={blend_path}")
    print(f"C1B_RW007_RENDER_DIRECTORY={render_directory}")
    print(f"C1B_RW007_REPORT={report_path}")
    print(f"C1B_RW007_RENDER_COUNT={len(outputs)}")
    print("C1B_RW007_BASE_EXACT_QA=" + json.dumps(base, sort_keys=True, separators=(",", ":")))
    print("C1B_RW007_EVALUATED_EXACT_QA=" + json.dumps(evaluated, sort_keys=True, separators=(",", ":")))
    print("C1B_RW007_GENERATION_RESULT=PASS")
